...
# # Overview
#
# Inside this example we contact [Workflow](https://docs.exabyte.io/api/Workflows/get_workflows) endpoint to obtain a list of
# workflows that an account has access to.
...
# ## Set Parameters
#
# - **QUERY**: A query describing the documents to find. See [Meteor
# collection](https://docs.meteor.com/api/collections.html#Mongo-Collection-find) for more information.
#
# - **limit**: Maximum number of results to return. See [Meteor collection](https://docs.meteor.com/api/collections.html#Mongo-
# Collection-find) for more information.
...
display_JSON(
    workflows, interactive_viewer=False

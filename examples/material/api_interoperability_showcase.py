...
# <a href="https://colab.research.google.com/github/Exabyte-io/exabyte-api-examples/blob/feature/SOF-4685/examples/material/api_interoperability_showcase.ipynb" target="_blank">Open in Google Colab</a>

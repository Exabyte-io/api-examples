...
# <a href="https://colab.research.google.com/github/Exabyte-io/exabyte-api-examples/blob/dev/examples/material/get_materials_by_formula.ipynb" target="_blank">Open in Google Colab</a>

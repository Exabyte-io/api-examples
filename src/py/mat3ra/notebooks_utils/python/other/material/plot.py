...
from ..plot._matplotlib import plot_distribution_function
from ..plot._plotly import create_scatter_plot_2d, render_figure
...
def plot_strain_vs_area(matches: List["ZSLMatchHolder"], settings: Dict[str, Union[str, int]]) -> None:
    ...
    fig = create_scatter_plot_2d(x_values, y_values, hover_texts, plot_settings, trace_names)
    render_figure(fig)

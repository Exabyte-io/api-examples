...
const URL =
  "http://localhost:8000/lab/index.html?path=experiments/relax_structure_with_uma.ipynb";
...
(async () => {
  ...
  // Monitor with logging until all cells done
  console.log("\n📊 Monitoring...");
  ...
  for (const r of results) {
    if (r.err) {
      ...
      console.log(r.out.substring(0, 1500));
      console.log();
    } else {

...
# <a href="https://colab.research.google.com/github/Exabyte-io/exabyte-api-examples/blob/feature/SOF-4685/examples/material/import_materials_from_poscar.ipynb" target="_blank">Open in Google Colab</a>
